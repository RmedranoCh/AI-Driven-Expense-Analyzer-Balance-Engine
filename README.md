...
*   **Capa de Inteligencia Artificial (Multimodal):** Pipeline de extracción asíncrono con **Groq API** utilizando `qwen/qwen3.6-27b` para análisis de visión sobre imágenes y `llama-3.3-70b-versatile` para extracción de entidades desde texto [1].
